  ...
  const steps = [
    {
      ...
      description: '아이가 원하는 이야기의 제목과 장르를 선택합니다.',
      icon: (
    ...
    },
    {
      ...
      description: '아이가 직접 이야기를 말하거나 글로 작성합니다.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12">
    ...
    },
    {
      ...
      description: '다양한 그림 스타일과 캐릭터를 선택하고 설정합니다.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12">
    ...
    },
    {
      ...
      description: '오디오북의 목소리를 선택하고 책 표지를 디자인합니다.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="w-12 h-12">
